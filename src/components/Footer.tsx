...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-[#27374D] text-white flex flex-col items-center gap-y-3 min-h-[75px] md:min-h-[85px] justify-center text-[10px] md:text-[14px] lg:flex-row lg:min-h-[95px] lg:justify-between lg:px-12">
        <div>
          <p>
